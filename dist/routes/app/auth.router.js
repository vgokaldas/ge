...
class AuthRouter {
    ...
    postRoutes() {
        ...
        this.router.post('/change-password', authentication_middleware_1.default.user, auth_validator_1.default.changePassword, auth_controller_1.default.changePassword);
    ...
    getRoutes() {
        this.router.get('/get-profile', authentication_middleware_1.default.user, auth_controller_1.default.getProfile);
    }
}
